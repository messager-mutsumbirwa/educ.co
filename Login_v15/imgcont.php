...
$dossier= 'C:xampp/htdocs/educ.com/view/image';
$fichier= basename($_FILES['icone']['name']);
$taille_maxi = 1000000;
$taille= filesize($_file['icone']['tmp_name']);
$extensions = array('.png', '.gif','.jfif',
'.jpg', '.jpeg');
$extension = strrchr($_file['icone']['name'], '.');
...
if(move_uploaded_file($_file ['icone']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
{
